...
const ShaderAnimation = ({ children, className = "" }: ShaderAnimationProps) => {
  ...
  useEffect(() => {
    ...
    const fragmentShaderSource = `
      ...
      void main() {
        ...
        // Add gradient overlay - Themed to Brenda's Red
        vec3 gradient1 = vec3(0.4, 0.0, 0.0); // Deep Red
        vec3 gradient2 = vec3(0.8, 0.1, 0.1); // Bright Red
  ...
  return (
    <div className={`relative w-full h-full overflow-hidden ${className}`}>
      ...
      <div className="absolute bottom-6 right-6 z-20">
        <button 
          className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 rounded-full px-4 py-1 text-[10px] uppercase font-bold tracking-widest text-white/70 transition-all"
